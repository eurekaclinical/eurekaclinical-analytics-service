...
public class DestinationToEtlDestinationVisitor extends AbstractDestinationVisitor {
    ...
    @Override
    public void visit(AOUParticipantDestination aouParticipantDestination) {
        EtlAouParticipantDestination etlAouParticipantDestination = new EtlAouParticipantDestination();
        visitCommon(aouParticipantDestination, etlAouParticipantDestination);
        this.etlDestination = etlAouParticipantDestination;
